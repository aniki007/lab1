    ...
    public partial class infor : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (null != b.ExecuteScalar())
            {
                ...
                string sq1 = "select location from course where cname = '" + cname + "'";
                ...
                string sq2 = "select time from course where cname = '" + cname + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (null == b.ExecuteScalar())
            {
                string sql = "insert into coustu select cid,sid from course,student where cname = '" + cname + "' and sname = '" + usname + "'";
