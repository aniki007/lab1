...
{
    public partial class teatable : Form
    {
        ...
        private void teatable_Load(object sender, EventArgs e)
        {
            ...
            a = "select * from tab,tabtea,teacher where teacher.tid=tabtea.tid and tabtea.taid = tab.taid and tname = '" + usname + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (null == com.ExecuteScalar())
            {
                ...
                b.CommandText = a;
                int num = b.ExecuteNonQuery();
                string c = "insert into tabtea select max(taid),teacher.tid from teacher,tab where tname = '" + usname + "' group by tid ";
